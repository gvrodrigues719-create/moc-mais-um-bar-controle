  ...
  return (
    <div className="space-y-5 py-5 max-w-lg mx-auto">
      ...
      >
        ...
        >
          <ClipboardList className="w-7 h-7" style={{ color: 'var(--brand)' }} />
        </div>
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-gray-400 max-w-xs mx-auto leading-relaxed">
            ...
            Aqui você poderá visualizar todas as sessões de contagem,
            auditar itens contados e cancelar sessões em andamento.
          </p>
        </div>
        <div className="flex items-center justify-center gap-1.5 text-[10px] font-bold uppercase tracking-wider text-gray-400">
          <Clock className="w-3.5 h-3.5" />
          <span>Fase 4 — Etapa 4</span>
        </div>
      </div>
    </div>
  )
